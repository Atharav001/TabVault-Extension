...
export default function EmptyState({ hasFilter }: { hasFilter: boolean }) {
  ...
  if (hasFilter) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        <div className={`size-10 rounded-xl border flex items-center justify-center mb-3 ${iconBg}`}>
          <svg className="size-5 text-zinc-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
      <div className={`size-12 rounded-2xl border flex items-center justify-center mb-4 shadow-sm ${iconBg}`}>
