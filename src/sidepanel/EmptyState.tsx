export default function EmptyState({ hasFilter }: { hasFilter: boolean }) {
  if (hasFilter) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="text-sm text-zinc-400">No matching items found</p>
        <p className="text-xs text-zinc-600 mt-1">Try a different search or collection filter</p>
      </div>
    )
  }
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-sm font-medium text-zinc-300">Vault is Empty</p>
