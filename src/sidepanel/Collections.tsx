  ...
  return (
    <button
      ...
      className={`
        ...
        ${isOver ? 'ring-1 ring-violet-500/60 border-violet-500/60 bg-zinc-800/60' : ''}
      `}
    >
      {name}
    </button>
    ...
    <div className="px-3 pb-2">
      <div className="flex items-center gap-1.5 overflow-x-auto scrollbar-none">
        <button
          ...
          className="shrink-0 size-6 flex items-center justify-center rounded-xl bg-zinc-900/40 backdrop-blur-sm text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800/40 text-sm border border-zinc-800/50 transition-colors"
